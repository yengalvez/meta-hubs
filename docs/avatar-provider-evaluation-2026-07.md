...
| MetaPerson Creator | Producto activo, cuerpo completo, integración web/JS y exportación GLB/GLTF/FBX con LOD, texturas, esqueleto, animaciones y visemas configurables; REST API solo Enterprise. La versión Desktop 1.35.0 figura con fecha 25-06-2026. | Pro: USD 800/mes, 6.000 avatares/mes y USD 0,03 por avatar adicional; incluye MetaPerson full-body y política de retención personalizada. Enterprise: precio a medida, REST y cómputo local/offline. El trial de Pro requiere cuenta y método de pago. | **Hold.** Técnicamente viable, pero exige cuenta/credenciales y revisión de coste por exportación/assets, contrato y DPA. Su política pública permite usar datos de imágenes para mejorar productos, entrenar algoritmos y depurar, y deja la retención concreta a instrucciones/acuerdo del cliente; no se debe probar con usuarios reales sin fijar por escrito finalidad, retención, transferencias, borrado, propiedad de outputs y continuidad. |
