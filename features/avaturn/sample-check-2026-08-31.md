...
miniatura locales; no la integración completa del loader, normalización en sala,
guardado persistente, privacidad entre cuentas, móvil o animaciones de Hubs.
...
workflow completo de build y se fusionó en `master=668413a20`. No se subió
ningún GLB de muestra ni hubo despliegue o acceso a producción durante esta
comprobación local.
